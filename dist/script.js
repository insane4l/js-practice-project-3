...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SubmittingForms; });
...
/*#__PURE__*/
function () {
  function SubmittingForms(formSelector, url) {
    _classCallCheck(this, SubmittingForms);
  ...
  _createClass(SubmittingForms, [{
    ...
    value: function initPhoneMask() {
      var setCursorPosition = function setCursorPosition(pos, elem) {
        ...
        if (elem.setSelectionRange) {
          ...
          // for old browsers (if setSelectionRange not supported)
    ...
    key: "bindSubmittingForms",
    value: function bindSubmittingForms() {
      var _this = this;

      this.forms.forEach(function (form) {
        return _this.handleSubmit(form);
      });
    }
  }, {
    key: "handleSubmit",
    value: function handleSubmit(form) {
      ...
      form.addEventListener('submit', function (e) {
        ...
        _this2.disableButtons(formBtns, true);

        var messageBlock = _this2.createStatusMessage(form.parentNode, _this2.message.loading);

        var formData = new FormData(form);

        _this2.postData(_this2.url, formData).then(function () {
          messageBlock.textContent = _this2.message.success;

          _this2.clearInputs(form);
        }).catch(function () {
          messageBlock.textContent = _this2.message.failure;

          _this2.disableButtons(formBtns, false);
        }).finally(function () {
          setTimeout(function () {
            messageBlock.remove();
    ...
    key: "createStatusMessage",
    value: function createStatusMessage(container, message) {
    ...
    key: "disableButtons",
    value: function disableButtons(btns, disabled) {
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggerSelector, overlaySelector) {
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var disabledBtn = btn.querySelector('.closed');
    ...
    value: function onPlayerStateChange(e) {
      try {
        if (e.data === 0) {
          var nextVideoBlock = this.activeBtn.closest('.module__video-item').nextElementSibling;
          var nextVideoBtn = nextVideoBlock.querySelector('.play__circle');
          var nextVideoBtnImg = nextVideoBtn.querySelector('svg');
          var nextVideoBtnText = nextVideoBlock.querySelector('.play__text');
          var playImg = this.activeBtn.querySelector('svg').cloneNode(true);
...
function (_Slider) {
  ...
  function MainSlider(container, nextBtns, resetBtns) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, container, nextBtns, resetBtns));
  }
  ...
  _createClass(MainSlider, [{
    ...
    key: "plussSlide",
    value: function plussSlide(n) {
      this.showSlide(this.slideIndex += n);
    }
  }, {
    key: "bindArrows",
    value: function bindArrows(btns, direction) {
      var _this2 = this;
    ...
    value: function bindTriggers() {
      ...
      this.resetBtns.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          ...
          _this3.showSlide(_this3.slideIndex);
        });
...
/***/ "./src/js/modules/slider/slider-secondary.js":
/*!***************************************************!*\
  !*** ./src/js/modules/slider/slider-secondary.js ***!
  \***************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SecondarySlider; });
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.symbol */ "./node_modules/core-js/modules/es.symbol.js");
/* harmony import */ var core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.symbol.description */ "./node_modules/core-js/modules/es.symbol.description.js");
/* harmony import */ var core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_symbol_description__WEBPACK_IMPORTED_MODULE_1__);
...
/*#__PURE__*/
function (_Slider) {
  _inherits(SecondarySlider, _Slider);

  function SecondarySlider(container, prevBtns, nextBtns, activeClass, animate, autoplay) {
    _classCallCheck(this, SecondarySlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(SecondarySlider).call(this, container, prevBtns, nextBtns, activeClass, animate, autoplay));
  }

  _createClass(SecondarySlider, [{
    key: "decorateActiveSlide",
    value: function decorateActiveSlide(slide) {
      var _this = this;
    ...
    key: "checkOtherChildren",
    value: function checkOtherChildren(childrenTag) {
      // check if container childrens not only slides (for example buttons position: absolute)
      var allChildren = this.container.children;
      if (_toConsumableArray(allChildren).some(function (el) {
        return el.tagName === childrenTag;
      })) this.hasOtherChildren = childrenTag;
    }
  }, {
    key: "showNextSlide",
    value: function showNextSlide() {
      ...
      if (!this.hasOtherChildren) {
        ...
        var slides = [];
        this.slides.forEach(function (el) {
          if (el.tagName !== _this2.hasOtherChildren) slides.push(el);
        });
    ...
    value: function bindTriggers() {
      ...
      this.prevBtns.forEach(function (el) {
        el.addEventListener('click', function () {
          _this3.activeSlide = _this3.slides[_this3.slides.length - 1];

          if (_this3.hasOtherChildren) {
            var slides = [];

            _this3.slides.forEach(function (el) {
              if (el.tagName !== _this3.hasOtherChildren) slides.push(el);
            });

            _this3.activeSlide = slides[slides.length - 1];
          }

          _this3.container.insertBefore(_this3.activeSlide, _this3.slides[0]);

          _this3.decorateActiveSlide(_this3.activeSlide);
        });
      });
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$resetBtns = _ref.resetBtns,
      resetBtns = _ref$resetBtns === void 0 ? null : _ref$resetBtns,
