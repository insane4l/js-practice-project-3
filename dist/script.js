...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var pagesSlider = new _modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"]('.page', '.sidecontrol__controls .next', '.main-logo');
  pagesSlider.render();
...
/*#__PURE__*/
function () {
  function Slider(sliderSelector, arrowsSelector, resetSelector) {
